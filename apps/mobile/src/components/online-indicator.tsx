 ...
 *   - Online + queue non-empty            → green "Syncing N event(s)…"
 *   - Offline (regardless of queue depth) → orange "Offline — N queued"
 *
 * Colors mirror Tailwind's `emerald-500` / `amber-500`. Inline styles
 * because the mobile app doesn't have a CSS-in-JS layer yet (Swimlane
 * B might add one); keeping the styles local means swapping themes
