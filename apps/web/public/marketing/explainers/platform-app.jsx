  ...
  return [
    {
      ...
      stage: 'COLD OPEN',
      stageLabel: 'YOUR FILE · YOUR KEYS',
      render: <PScene1ColdOpen />,
      showScene: false,
      showBrand: true,
      block: '#00184_2B',
      hash: '0xe9c4…d2a7',
    ...
    },
    {
      ...
      stage: 'STAGE 05',
      stageLabel: 'PRICING · TRIAL · PER-CLAIM',
      render: <PScene7Pricing />,
      block: '#00184_2B',
      hash: '0xe9c4…d2a7',
    },
    {
    ...
    },
    {
      ...
      stage: 'OFFER',
      stageLabel: `FOUNDER COHORT · ${tw.founderPct}% OFF · ${tw.founderSeats} SEATS`,
      render: <PScene10Offer />,
      block: '#00184_2B',
      hash: '0xe9c4…d2a7',
    },
    {
      ...
      stage: 'PHASE 2',
      stageLabel: 'FOUNDATION ACCESS · CLAIM FINANCING',
      render: <PScene11Foundation />,
      block: '#00184_2B',
      hash: '0xe9c4…d2a7',
    },
    {
  ...
  return (
    ...
    >
      <Stage
        ...
        duration={106}
        background={csInk}
        persistKey="archiveone-platform"
      >
        <CSBackdrop />
      ...
      <TweaksPanel>
        ...
        <div
          style={{
            padding: '8px 10px',
            borderRadius: 6,
            background: 'rgba(225,162,58,0.10)',
            border: '1px solid rgba(225,162,58,0.35)',
            display: 'flex',
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10.5 }}>
            ...
            <span style={{ color: '#29261b', fontWeight: 600 }}>
              ${founderClm.toLocaleString()}/claim
            </span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 10.5 }}>
            <span style={{ color: 'rgba(41,38,27,0.6)', letterSpacing: '0.1em' }}>STANDARD</span>
            <span style={{ color: '#29261b', fontWeight: 600 }}>
              ${tweaks.perClaim.toLocaleString()}/claim
            </span>
          </div>
        </div>
      </TweaksPanel>
