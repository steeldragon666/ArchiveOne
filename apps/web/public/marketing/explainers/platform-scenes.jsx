  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      >
        ...
        >
          THE PLATFORM · TECHNICAL & COMMERCIAL DETAIL
        </span>
      </div>
    ...
    >
      <div
        style={{
          ...
          height: 24,
          background: csAmber,
          transform: `rotate(45deg) scale(${burstScale})`,
...
function PScene3Sovereign() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <PSceneHeader
        stage="STAGE 01"
        stageLabel="SOVEREIGN"
        title={
          <>
            Sovereign{' '}
            <em style={{ color: csBone2, fontStyle: 'italic', fontWeight: 300 }}>
              — in country, end to end.
            </em>
          </>
        }
...
function PSovereignMap({ localTime }) {
  ...
  const auPath =
    'M 60 130 L 110 110 L 170 100 L 230 95 L 290 92 L 340 96 L 390 110 L 430 140 L 450 175 L 460 215 L 458 250 L 440 285 L 410 315 L 360 335 L 290 345 L 220 348 L 160 340 L 110 320 L 80 290 L 55 250 L 50 210 L 52 170 Z';
  const dots = [
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            style={{ fontFamily: fMono, fontSize: 11, color: csAmber, letterSpacing: '0.18em' }}
          >
            AUSTRALIAN SOVEREIGN ZONE
          </span>
          <span
            style={{ fontFamily: fMono, fontSize: 10, color: csBone3, letterSpacing: '0.12em' }}
          >
      ...
      >
        <span>
          <span style={{ color: csAmber }}>◆</span> IRAP-ALIGNED · ISO 27001
        </span>
        <span>
          <span style={{ color: csAmber }}>◆</span> CLOUD ACT-IMMUNE
        </span>
      </div>
    </div>
  );
  ...
  const layers = [
    {
      ...
      k: 'L1 · DATA KEY',
      v: 'AES-256-GCM',
      sub: 'unique per claim · rotated per session',
      code: 'DEK',
    },
    {
      at: 1.6,
      k: 'L2 · MASTER KEY',
      v: 'RSA-4096 ENVELOPE',
      sub: 'unique per claimant · wraps every DEK',
      code: 'KEK',
    },
    {
      at: 2.2,
      k: 'L3 · ROOT (HSM)',
      v: 'FIPS 140-2 LEVEL 3',
      sub: 'air-gapped · split-knowledge custody',
      code: 'ROOT',
    },
  ];
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontFamily: fMono, fontSize: 10.5, color: csBone3, letterSpacing: '0.14em' }}
        >
          47 ARTIFACTS · 312 MB
        </span>
      </div>
      ...
      {layers.map((l, i) => {
        ...
        return (
          <div
            ...
            style={{
              opacity: lt,
              transform: `translateY(${(1 - lt) * 16}px)`,
              marginBottom: 14,
          ...
          >
            ...
            >
              <div style={{ color: csBone4, marginBottom: 4, letterSpacing: '0.14em' }}>
                {l.code}
              </div>
              <div>
                0x{settleHash('a91f4c7d2e8b'.slice(0, 8 + i * 2), localTime - l.at - 0.3, 0.7)}
              </div>
            </div>
          </div>
        );
      ...
      >
        <span>
          <span style={{ color: csAmber }}>◆</span> ZERO-KNOWLEDGE TO OPERATORS
        </span>
        <span>
          <span style={{ color: csAmber }}>◆</span> CLIENT-SIDE KEY GENERATION
        </span>
      </div>
    </div>
  );
...
function POwnershipDiagram({ localTime }) {
  ...
  const rights = [
    ...
    { k: 'WRITE', claimant: true, consultant: true, at: 1.3, note: 'within scope of engagement' },
    {
      ...
      consultant: true,
      at: 1.6,
      note: 'sealed bundle · cryptographic chain',
    },
    {
      k: 'TRANSFER',
      claimant: true,
      consultant: false,
      at: 1.9,
      note: 'move file to another consultancy',
    },
    {
      k: 'REVOKE',
      claimant: true,
      consultant: false,
      at: 2.2,
      note: 'cancel access · any time · any party',
    },
    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          <Diamond size={8} color={csAmber} filled />
          <span
            style={{ fontFamily: fSerif, fontSize: 22, color: csBone, letterSpacing: '-0.01em' }}
          >
            Claim file
          </span>
          <span
            style={{ fontFamily: fMono, fontSize: 10, color: csBone3, letterSpacing: '0.16em' }}
          >
      ...
      >
        ...
        >
          <span>RIGHT</span>
          <span>SCOPE</span>
          <span style={{ textAlign: 'center' }}>CLAIMANT</span>
          <span style={{ textAlign: 'center' }}>CONSULT.</span>
        </div>
        {rights.map((r, i) => {
          ...
          return (
            ...
            >
              <span
                style={{ fontFamily: fMono, fontSize: 12, color: csAmber, letterSpacing: '0.14em' }}
              >
                {r.k}
              </span>
      ...
      <div>
        <div
          style={{
            fontFamily: fMono,
            fontSize: 11,
            color: highlight ? csAmber : csBone2,
            letterSpacing: '0.22em',
          }}
        >
          {label}
...
function PCheck({ on }) {
  ...
  return <span style={{ display: 'inline-block', width: 14, height: 1, background: csBone4 }} />;
}
          ...
          return (
            <div
              ...
              style={{
                ...
                marginBottom: 5,
                opacity,
                transform: `translateX(${(1 - lt) * 40}px)`,
                fontFamily: fMono,
                fontSize: 11.5,
                color: csBone,
            ...
            >
              <span>{it.label}</span>
              <span style={{ color: csBone3, fontSize: 10.5, letterSpacing: '0.14em' }}>
                {it.n}
              </span>
            </div>
          );
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: 'right' }}>
            <div
              style={{ fontFamily: fMono, fontSize: 10, color: csBone3, letterSpacing: '0.14em' }}
            >
              SIZE
            </div>
        ...
        >
          {[
            ...
            >
              <div
                style={{ fontFamily: fMono, fontSize: 10, color: csAmber, letterSpacing: '0.16em' }}
              >
                {k}
              </div>
              <div style={{ fontFamily: fSans, fontSize: 12, color: csBone2, marginTop: 4 }}>
                {v}
              </div>
            </div>
          ))}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{
            flex: 1,
            height: 1,
            background: `linear-gradient(to right, ${csAmber}, ${csRuleStr})`,
          }}
        />
        <span>DAY 30</span>
      ...
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: '1fr 40px 1fr 40px 1.1fr',
          gap: 0,
          alignItems: 'stretch',
        }}
      >
...
function PScene8ClientApp() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <PSceneHeader
        stage="STAGE 06"
        stageLabel="CLIENT APP"
        title={
          <>
            Client app{' '}
            <em style={{ color: csBone2, fontStyle: 'italic', fontWeight: 300 }}>
              — a second line of revenue.
            </em>
          </>
        }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ fontFamily: fMono, fontSize: 9, color: csAmber, letterSpacing: '0.18em' }}
            >
              ACTIVE PROJECT
            </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontFamily: fSans, fontSize: 11, color: csBone, marginTop: 4 }}>
                    {v}
                  </div>
                </div>
              );
      ...
      >
        <div style={{ fontFamily: fMono, fontSize: 10, color: csAmber, letterSpacing: '0.2em' }}>
          SOLD BY CONSULTANCY
        </div>
        <div
          style={{ fontFamily: fSerif, fontSize: 22, color: csBone, lineHeight: 1, marginTop: 4 }}
        >
          White-labelled
        </div>
      </div>
  ...
  const props = [
    {
      at: 1.7,
      k: 'CONTEMPORANEOUS',
      v: 'Researchers capture in the moment — at the bench, the whiteboard, the test rig.',
    },
    {
      at: 1.95,
      k: 'WHITE-LABELLED',
      v: 'Your consultancy’s brand on the cover. Your relationship in the foreground.',
    },
    {
      at: 2.2,
      k: 'STICKY BY DESIGN',
      v: 'Daily usage by the claimant’s team. Departure cost rises with every capture.',
    },
    {
      at: 2.45,
      k: 'MARGIN OPTIONAL',
      v: 'Bundle it with your engagement, or resell it standalone — the economics are yours to set.',
    },
  ];
  return (
    <div
          ...
          return (
            <div
              ...
              style={{
                ...
                opacity: lt,
                transform: `translateX(${(1 - lt) * -20}px)`,
                alignItems: 'baseline',
                gap: 18,
              }}
            >
        ...
        {rows.map((r, i) => {
          ...
          return (
            ...
            >
              ...
              <span style={{ color: i === rows.length - 1 ? csAmber : csBone, textAlign: 'right' }}>
                {r[2]}
              </span>
            </div>
          );
...
function PEconChart({ localTime }) {
  ...
  const rows = [
    ...
    },
    {
      ...
      val: 18000,
      unit: `${fmtFull(getTweaks().perClaim)} × claim`,
      dir: 'pay as you bill',
      isCs: true,
    },
  ];
  ...
  return (
    ...
    >
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: '230px 1fr 200px 180px',
          gap: 22,
          padding: '0 0 12px',
          borderBottom: `1px solid ${csRuleStr}`,
          fontFamily: fMono,
      ...
      >
        ...
        >
          <span>
            <span style={{ color: csAmber }}>◆</span> PI PREMIUMS WILL KEEP RISING
          </span>
          <span>
            <span style={{ color: csAmber }}>◆</span> THE ONLY MEANINGFUL REDUCTION
          </span>
        </div>
      </div>
    </div>
...
function PScene10Offer() {
  ...
  const taken = Math.min(
    tw.founderSeats,
    Math.floor(plerp(0, targetTaken, Easing.easeOutCubic(clamp(localTime / 1.6, 0, 1)))),
  );
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      >
        ...
        >
          FOUNDER COHORT · LIMITED RELEASE
        </span>
      </div>
      ...
      >
        ...
        &nbsp;to sign on. Per-claim fee drops to {fmtFull(founderClm)} for the founding year — and
        stays locked at the founder rate for life. No annual minimum. No setup fee.
      </div>
      ...
      <PSlotBoard
        localTime={localTime}
        taken={taken}
        seats={tw.founderSeats}
        founderClm={founderClm}
        fullClm={tw.perClaim}
      />
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: `repeat(${Math.min(seats, 5)}, 1fr)`,
          gap: 12,
        }}
      >
      ...
      >
        <div>
          <div style={{ fontFamily: fMono, fontSize: 10, color: csBone3, letterSpacing: '0.18em' }}>
            FOUNDER · PER CLAIM
          </div>
          <div
            style={{
          ...
          >
            {fmtFull(founderClm)}
            <span style={{ fontFamily: fMono, fontSize: 13, color: csBone3 }}> /claim</span>
          </div>
        </div>
        <div style={{ textAlign: 'right' }}>
          <div style={{ fontFamily: fMono, fontSize: 10, color: csBone3, letterSpacing: '0.18em' }}>
          ...
          >
            {fmtFull(fullClm)}
            <span style={{ fontFamily: fMono, fontSize: 13, color: csBone4 }}> /claim</span>
          </div>
        </div>
      </div>
    </div>
...
function PScene11Foundation() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <PSceneHeader
        stage="PHASE 2"
        stageLabel="FOUNDATION ACCESS"
        title={
          <>
            Next{' '}
            <em style={{ color: csBone2, fontStyle: 'italic', fontWeight: 300 }}>— financing.</em>
          </>
        }
  ...
  const steps = [
    {
      ...
      n: '01',
      k: 'SEAL',
      t: 'Claim sealed in ArchiveOne',
      d: 'evidence + chain + brief, ready',
    },
    {
      at: 1.4,
      n: '02',
      k: 'FINANCE',
      t: 'Financing offered against rebate',
      d: 'one-click, pre-priced, instant',
    },
    {
      at: 1.8,
      n: '03',
      k: 'ORIGINATE',
      t: 'Consultancy earns origination margin',
      d: 'a new line of revenue, every claim',
    },
    {
      at: 2.2,
      n: '04',
      k: 'RETAIN',
      t: 'Client locked into the platform',
      d: 'too integrated, too simple to leave',
    },
  ];
  return (
    <div
          ...
          <React.Fragment key={i}>
            <div
              style={{
                ...
                padding: '16px 20px',
                background: csInk2,
                border: `1px solid ${last ? csAmber : csRuleStr}`,
                borderRadius: 4,
                opacity: lt,
                transform: `translateX(${(1 - lt) * -24}px)`,
                alignItems: 'center',
              }}
            >
              <div
    ...
    >
      ...
      >
        ...
        >
          ...
          <span style={{ fontSize: 28, color: csBone2 }}>financed claims a year</span>
        </div>
        <div
          style={{
            fontFamily: fSans,
        ...
        >
          covers a year of per-claim fees in origination margin alone. Everything beyond is pure
          upside &mdash; before you count retention, before you count the client app.
        </div>
        <div
          style={{
            marginTop: 18,
        ...
        >
          <span>
            <span style={{ color: csAmber }}>◆</span> LOAN ORIGINATION REVENUE
          </span>
          <span>
            <span style={{ color: csAmber }}>◆</span> CLIENT RETENTION UPLIFT
          </span>
          <span>
            <span style={{ color: csAmber }}>◆</span> FOUNDATION COHORT FIRST
          </span>
        </div>
      </div>
    </div>
