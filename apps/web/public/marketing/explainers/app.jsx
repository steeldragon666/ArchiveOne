...
const SCENES = [
  {
    ...
    stage: 'COLD OPEN',
    stageLabel: 'THE NEW REALITY',
    render: <Scene1ColdOpen />,
    showScene: false,
    showBrand: true,
    block: '#00184_2A',
    hash: '0x7f3a…c4e1',
  ...
  },
  {
    ...
    stage: 'PAYOFF',
    stageLabel: 'CONSULTANT TIME · RETURNED',
    render: <Scene9Stat />,
    block: '#00184_2A',
    hash: '0x7f3a…c4e1',
  },
  ...
  return (
    ...
    >
      <Stage
        ...
        duration={72}
        background={csInk}
        persistKey="archiveone-explainer"
      >
        <CSBackdrop />
