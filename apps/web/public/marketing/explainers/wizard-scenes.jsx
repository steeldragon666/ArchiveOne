  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      >
        ...
        >
          HOW THE PLATFORM COMPOUNDS · FY25/26 → FY26/27
        </span>
      </div>
  ...
  const steps = [
    {
      at: 0.9,
      k: 'PROFILE',
      q: 'What does the business do, and where does it sit on the innovation curve?',
      a: 'Hi-temp alloys · ARL-3 maturity · 47 staff · FY25 turnover $18.2M',
    },
    {
      at: 1.6,
      k: 'HYPOTHESES',
      q: 'What did you set out to learn, and why was the answer unknown?',
      a: 'Phase stability of Vantage-7 above 800 °C · no published data at this composition',
    },
    {
      at: 2.3,
      k: 'ACTIVITIES',
      q: 'Which work is Core? Which is Supporting?',
      a: '4 Core · 7 Supporting · provisional classification applied',
    },
    {
      at: 3.0,
      k: 'EVIDENCE',
      q: 'Where did the work happen, and what proves it?',
      a: '47 chain-anchored artifacts · 6 contemporaneous voice notes',
    },
    {
      at: 3.7,
      k: 'APPORTIONMENT',
      q: 'How does the ledger map to the activities?',
      a: 'Xero feed reconciled · $238K wages · $42K contractor · $14K overhead',
    },
    {
      at: 4.4,
      k: 'REVIEW',
      q: 'Anything to flag before sign-off?',
      a: '2 weak hypotheses · suggested follow-ups drafted · awaiting consultant',
    },
  ];
  // active step
  let activeIdx = 0;
          ...
          {steps.map((s, i) => {
            ...
            return (
              <div
                ...
                style={{
                  display: 'grid',
                  gridTemplateColumns: '140px 1fr 20px',
                  gap: 14,
                  padding: '7px 0',
                  fontFamily: fMono,
                  fontSize: 11.5,
    ...
    >
      ...
      >
        ...
        <svg
          ...
          height="540"
          viewBox="0 0 730 540"
          style={{ position: 'absolute', left: 24, top: 50, overflow: 'visible' }}
        >
          {/* edges */}
          {nodes.map((n, i) => {
          ...
          {nodes.map((n, i) => {
            ...
            return (
              <g
                key={i}
                opacity={lt}
                transform={`translate(${n.x},${n.y}) scale(${0.7 + 0.3 * lt})`}
              >
                <circle
                  cx="0"
                  cy="0"
                  r={20 * pulse}
                  fill="rgba(225,162,58,0.08)"
                  stroke={csAmber}
                  strokeWidth="1"
                />
...
function WScene6Understanding() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <WSceneHeader
        stage="STAGE 04"
        stageLabel="INFLECTION · JUNE 30 → JULY 1"
        title={
          <>
            June 30{' '}
            <em style={{ color: csBone2, fontStyle: 'italic', fontWeight: 300 }}>
...
function WScene7Mobile() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      <WSceneHeader
        stage="STAGE 05"
        stageLabel="FY26/27 · MOBILE ARRIVES"
        title={
          <>
            From July 1,{' '}
            <em style={{ color: csBone2, fontStyle: 'italic', fontWeight: 300 }}>
              your team gets the app.
            </em>
          </>
        }
  ...
  const msgs = [
    {
      at: 1.0,
      who: 'app',
      txt: 'Morning Priya. Vantage-7 furnace run N12 — same protocol as N7?',
      delay: 0.4,
    },
    { at: 2.2, who: 'user', txt: 'Yes — new alloy ratio though, B+8%.', delay: 0.4 },
    {
      at: 3.0,
      who: 'app',
      txt: 'Logged as Core · hypothesis branch from N7. Snap the post-cycle plate when you can.',
      delay: 0.4,
    },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              style={{ fontFamily: fMono, fontSize: 10, color: csBone4, letterSpacing: '0.16em' }}
            >
              SPEAK · PHOTO · TYPE
            </span>
            <div
      ...
      >
        ...
        >
          The app opens to a researcher who is already known, on a project that is already
          understood.
        </div>
      </div>
    </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                opacity: lt,
                transform: `translateY(${(1 - lt) * 12}px)`,
              }}
            >
              <div
                style={{
  ...
  const years = [
    {
      ...
      y: 12,
      k: 'FY25/26',
      l: 'Foundational facts',
      v: 'business profile · ledger · prior claims',
    },
    {
      x: 0.33,
      y: 32,
      k: 'FY26/27',
      l: 'Patterns + advice',
      v: 'rhythm · cost shape · evidence habits',
    },
    {
      x: 0.66,
      y: 62,
      k: 'FY27/28',
      l: 'Predictive',
      v: 'forecast · proactive risk · audit-tested',
    },
      ...
      >
        ...
        <svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} style={{ overflow: 'visible' }}>
          ...
          {[0, 25, 50, 75, 100].map((g) => {
            ...
            return (
              <g key={g}>
                <line x1={padL} y1={y} x2={w - padR} y2={y} stroke={csRule} strokeWidth="1" />
                <text
                  x={padL - 10}
                  y={y + 4}
                  textAnchor="end"
        ...
        {/* legend rows below */}
        <div
          style={{ marginTop: 16, display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}
        >
          {years.map((y, i) => {
...
function WValueStack({ localTime }) {
  ...
  const items = [
    { at: 1.2, k: 'TIME RETURNED', share: 18, v: 'Consultant judgement, not evidence assembly' },
    {
      ...
      k: 'CLAIM QUALITY',
      share: 28,
      v: 'Constantly updated logic — every ATO alert, AAT decision and AusIndustry guidance, ingested daily',
    },
    {
      at: 2.0,
      k: 'ADVISOR EFFECT',
      share: 14,
      v: 'Proactive forecast & posture, not reactive triage',
    },
    {
      at: 2.4,
      k: 'FINANCING MARGIN',
      share: 18,
      v: 'A new pathway for streamlining and originating finance for clients',
    },
    {
      at: 2.8,
      k: 'CLAIMANT RETENTION',
      share: 22,
      v: 'Daily app usage by the claimant&rsquo;s team \u2014 stickiness, not seat licensing',
    },
  ];
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <div
          style={{
            width: 120,
            height: 60,
            background: 'rgba(225,162,58,0.15)',
            border: `1px solid ${csAmber}`,
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'stretch' }}>
        ...
        >
          ...
          >
            All of it rests on one foundation: immutable evidence, immune from rejection by
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      >
        ...
        >
          APPLY NOW TO BE ONE OF 20 CONSULTANCIES WITH PLATFORM ACCESS
        </span>
      </div>
