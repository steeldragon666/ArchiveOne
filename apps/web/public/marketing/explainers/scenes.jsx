...
function ColdOpenTicker({ localTime }) {
  ...
  return (
    ...
    >
      <div
        style={{ display: 'inline-block', transform: `translateX(${x}px)`, paddingLeft: '100%' }}
      >
        {phrases
          .concat(phrases)
          .concat(phrases)
          .map((p, i) => (
            <span key={i} style={{ marginRight: 80 }}>
              <span style={{ color: csAmber, marginRight: 14 }}>◆</span>
              {p}
            </span>
          ))}
      </div>
    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ fontFamily: fMono, fontSize: 12, color: csBone, marginTop: 6 }}>
            whiteboard_n7.jpg
          </div>
        </div>
        <div
      ...
      {/* Arrow / hash flow */}
      <svg
        style={{ position: 'absolute', left: 200, top: 200, pointerEvents: 'none' }}
        width="280"
        height="60"
      >
        <line
      ...
      {blocks.map((b, i) => {
        ...
        return (
          <React.Fragment key={i}>
            ...
            >
              <div
                style={{ fontFamily: fMono, fontSize: 9.5, color: csAmber, letterSpacing: '0.1em' }}
              >
                #{b.id}
              </div>
              <div
              ...
              <div
                style={{ marginTop: 8, width: 22, height: 1, background: csAmber, opacity: 0.5 }}
              />
            </div>
            {i < blocks.length - 1 && (
              <div
...
function AssemblyDoc({ localTime }) {
  ...
  const sections = [
    ...
    {
      at: 2.2,
      k: 'TECHNICAL UNCERTAINTY',
      v: 'No published evidence for grain-boundary behaviour at this composition.',
    },
    {
      at: 3.0,
      k: 'SYSTEMATIC PROGRESSION',
      v: 'Iterative furnace runs N4–N7, post-cycle metallography, EBSD.',
    },
    {
      at: 3.8,
      k: 'CORE ACTIVITY',
      v: 'Synthesis & characterisation of Vantage-7 specimen series.',
    },
    { at: 4.6, k: 'SUPPORTING', v: 'Fixturing design; environmental conditioning; data pipeline.' },
    {
      at: 5.4,
      k: 'EVIDENCE',
      v: '47 artifacts · whiteboard, voice, lab-book, calc — all chain-anchored.',
    },
  ];
  return (
    <div
    ...
    >
          ...
          >
            ...
            >
              ...
              <span style={{ marginLeft: 8 }}>
                ...
                >
                  SRC · #{(184 + i * 3).toString(16).toUpperCase()}_2{String.fromCharCode(65 + i)}
                </span>
              </span>
            </div>
          </div>
      ...
      >
        <span>
          <span style={{ color: csAmber }}>◆</span> DIVISION 355 · ITAA 1997
        </span>
        <span>
          <span style={{ color: csAmber }}>◆</span> NO HALLUCINATED HYPOTHESIS
        </span>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <div
        style={{
          display: 'grid',
          gridTemplateColumns: '120px 180px 1fr 120px 100px',
          gap: 18,
          padding: '12px 18px',
          borderBottom: `1px solid ${csRuleStr}`,
          fontFamily: fMono,
      ...
      {signals.map((s, i) => {
        ...
        return (
          ...
          >
            <span
              style={{ fontFamily: fMono, fontSize: 12, color: csAmber, letterSpacing: '0.16em' }}
            >
              {s.src}
            </span>
            <div>
            ...
            <span
              style={{ fontFamily: fMono, fontSize: 11, color: csBone3, letterSpacing: '0.08em' }}
            >
              {s.when}
            </span>
          </div>
      ...
      >
        ...
        >
          ...
          <defs>
            <path
              id="ringPath"
              d="M 320 320 m -260 0 a 260 260 0 1 1 520 0 a 260 260 0 1 1 -520 0"
            />
          </defs>
          <text fill={csBone3} fontFamily={fMono} fontSize="11" letterSpacing="8" opacity="0.7">
            <textPath href="#ringPath" startOffset={`${(localTime * 5) % 100}%`}>
              · BLOCK 00184_2A · IMMUTABLE · DEFENSIBLE · SEALED · 2026.05.21 · 14:23 AEST ·
              OMNISCIENT AI · SOVEREIGN R&amp;DTI · CHAIN-ANCHORED ·
            </textPath>
          </text>
        </svg>
        ...
        >
          ...
          >
            <div
              style={{ fontFamily: fMono, fontSize: 11, color: csAmber, letterSpacing: '0.22em' }}
            >
              SEALED
            </div>
            <div
  ...
  return (
    <div style={{ position: 'absolute', inset: 0 }}>
      ...
      >
        ...
        <span
          style={{
            ...
            fontVariationSettings: '"opsz" 144, "SOFT" 100',
            opacity: showHigh,
            transform: `translateY(${(1 - showHigh) * 30}px)`,
            display: 'inline-block',
          }}
        >
          –95
      ...
      >
        ...
        >
          ArchiveOne does the assembly. The consultant does the judgement. Quality does not
          depreciate — it improves. Every claim fully evidenced, every hypothesis prior-supported,
          every line of apportionment traceable.
        </div>
      </div>
    </div>
  );
